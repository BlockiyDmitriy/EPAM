...
namespace TaxiStation
{
    public class ElectroCar : Car
    {
        ...
        public ElectroCar(Brand brand, TypeCar typeCar, Engine engine, int price, string number,string color, string model, int minSpeed, int maxSpeed, int weigtht, //base
